    ...
    <div id="user-input">
      <div className="input-group">
        <form>
          ...
          <input type="number" required value={values.initialInvestment} onChange={handleInitialInvestment} />
        </form>
        <form>
          <label>Annual Investment</label>
          <input type="number" required value={values.annualInvestment} onChange={handleAnnualInvestment}/>
        </form>
      </div>
      ...
      <div className="input-group">
        <form >
          ...
          <input type="number" required value={values.expectedReturn} onChange={handleExpectedReturn}/>
        </form>
        <form >
          <label>Duration</label>
          <input type="number" required value={values.duration} onChange={handleDuration}/>
        </form>
      </div>
    </div>
  );
